...
CREATE TABLE Movimentacao (
	...
	SALDO DECIMAL(15,2) NOT NULL,
	CONSTRAINT FK_MOV_AGE FOREIGN KEY (NUM_AGE) REFERENCES Agencias(NUM_AGE),
	CONSTRAINT FK_MOV_CC FOREIGN KEY (NUM_CC, NUM_AGE) REFERENCES ContaCorrente(NUM_CC, NUM_AGE),
	CONSTRAINT FK_MOV_HIS FOREIGN KEY (ID_HIS) REFERENCES Historicos(ID_HIS),
